...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to dtmid "gobject list" output
    ...
    def dtmid_serialise(self):
        import dtmilib
        return dtmilib.SHIM_serialise_for_dtmid(self.serialise())
